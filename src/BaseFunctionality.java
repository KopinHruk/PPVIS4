...
import src.actions.ActionInterfaceAdditionalButton;
...
public class BaseFunctionality extends Composite {

    public BaseFunctionality(Composite parent, int style) {
        super(parent, style);
        ...
        ActionInterfaceAdditionalButton additionalButton = new ActionInterfaceAdditionalButton("Extra task", this, inputField);
    }
